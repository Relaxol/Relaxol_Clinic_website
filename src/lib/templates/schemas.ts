...
export function createDefaultHomeContent(): HomeV1Content {
  return {
    ...
    treatments: {
      ...
      items: [
        { title: "SPRAVATO® (Esketamine Nasal Spray)", tag: "FDA-Approved", description: "FDA‑approved treatment for resistant depression, offering proven relief when standard antidepressants fail. It is administered under medical supervision for safety.", ctaLabel: "Learn More", href: "/spravato-Englewood" },
        { title: "Ketamine Infusion Therapy for Relief", description: "Precisely controlled IV ketamine therapy offering rapid relief for Depression, Anxiety, PTSD, and OCD. Ideal for patients who haven't responded to standard treatments.", ctaLabel: "Learn More", href: "/ketamine" },
        { title: "Chronic Pain Management Solutions", description: "Comprehensive pain management solutions including ketamine infusions for Chronic Pain conditions. Our approach targets pain at its source for lasting relief.", ctaLabel: "Learn More", href: "/conditions/pain-management" },
        { title: "Comprehensive Evaluations", tag: "Assessment", description: "A comprehensive psychiatric evaluation is the first step in understanding your symptoms, history, and treatment goals. Personalized, thoughtful, clinician-led care.", ctaLabel: "Learn More", href: "/evaluations" },
      ],
    },
    conditions: {
    ...
    whyChoose: {
      ...
      items: [
        ...
        { title: "Evidence-Based Protocols", description: "We follow the latest research and FDA guidelines to ensure our treatments are safe, effective, and grounded in science. Our protocols are continuously updated as new evidence emerges." },
        { title: "Insurance & Billing Support", description: "Navigating insurance for mental health treatment can be confusing. Our team helps verify your benefits and submit claims so you can focus on getting better." },
        { title: "Private Treatment Rooms", description: "Your comfort and privacy matter. Our clinic features individual treatment rooms designed to create a calming, confidential environment for every session." },
      ],
    },
    testimonials: {
      ...
      items: [
        { quote: "After years of trying different medications, I was skeptical that anything would work. Within a few weeks of starting SPRAVATO®, I noticed a shift. The fog lifted. I'm not 'cured,' but I finally feel like myself again.", author: "M.R.", role: "SPRAVATO® Patient", rating: 5 },
        { quote: "The staff made me feel safe from the moment I walked in. The treatment itself was surprisingly calm, and the relief I felt afterward was unlike anything I'd experienced before. I wish I'd found this clinic sooner.", author: "J.L.", role: "Ketamine Infusion Patient", rating: 5 },
        { quote: "I came here after a trauma that left me unable to function. The doctor and the team were incredibly compassionate. The ketamine treatments helped me process things I'd been avoiding for years. I'm grateful beyond words.", author: "S.T.", role: "PTSD Treatment Patient", rating: 5 },
      ],
    },
    timeline: {
      subtitle: "HOW IT WORKS",
      ...
      items: [
        { step: "1", title: "Consultation", description: "During your initial consultation, we'll review your medical history, discuss your symptoms, and determine whether ketamine or SPRAVATO® therapy is right for you." },
        { step: "2", title: "Insurance Check", description: "Our team will verify your insurance coverage for SPRAVATO® (which is often covered) and explain any out-of-pocket costs for ketamine infusions." },
        { step: "3", title: "Treatment", description: "You'll receive your treatment in a private, comfortable room under the supervision of our clinical staff. Sessions typically last 1–2 hours depending on the therapy." },
        { step: "4", title: "Follow-Up", description: "After your session, we'll check in to monitor your response and adjust your care plan as needed. Follow-up appointments can often be done via telehealth." },
        { step: "5", title: "Long-Term Care", description: "Mental health is a journey. We offer ongoing support, including maintenance treatments and psychiatric follow-ups, to help you sustain your progress over time." },
      ],
    },
    coverage: {
