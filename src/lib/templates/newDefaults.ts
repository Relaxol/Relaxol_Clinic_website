...
import { ConditionV1Content, VitaminInfusionsV1Content, OurTeamV1Content } from './newSchemas';
...
export const defaultVitaminInfusionsContent: VitaminInfusionsV1Content = {
    ...
    items: [
      {
        ...
        benefits: ['Boosts metabolism', 'Increases energy levels', 'Supports fat burning', 'Enhances athletic performance', 'Reduces fatigue'],
      ...
      },
      {
        ...
        benefits: ['Rapid rehydration', 'Restores electrolyte balance', 'Relieves fatigue and headaches', 'Improves skin hydration', 'Supports kidney function'],
      ...
      },
      {
        ...
        benefits: ['Accelerates muscle recovery', 'Reduces inflammation', 'Replenishes electrolytes', 'Reduces muscle soreness', 'Enhances endurance'],
      ...
      },
      {
        ...
        benefits: ['Strengthens immune system', 'High-dose Vitamin C therapy', 'Protects against infections', 'Reduces cold and flu duration', 'Powerful antioxidant support'],
      ...
      },
      {
        ...
        benefits: ['Reduces fine lines and wrinkles', 'Brightens and evens skin tone', 'Strengthens hair and nails', 'Powerful antioxidant detox', 'Promotes collagen production'],
      ...
      },
      {
        ...
        benefits: ['Reduces bloating and cramping', 'Relieves PMS symptoms', 'Relaxes muscle tension', 'Reduces inflammation', 'Promotes digestive comfort'],
  ...
  b12: {
    ...
    modalDescription: "Vitamin B12 is essential for energy, brain function, and overall health, but your body needs a protein called intrinsic factor, produced in the stomach, to absorb it properly. If your body doesn't produce enough, a deficiency can occur. Intramuscular B12 injections are an effective way to restore healthy B12 levels and support your wellbeing.",
    modalBenefits: [
      'Boosts energy levels', 'Supports brain function and concentration', 'Improves metabolism',
      'Helps prevent anemia', 'Supports mood and may relieve depression', 'Strengthens immunity',
      'Promotes bone health and reduces risk of osteoporosis', 'Enhances heart health',
      'Improves sleep quality', 'Supports healthy hair, skin, and nails', 'Reduces hair loss',
  ...
  nad: {
    ...
    modalDescription: 'NAD+ is a vital molecule our bodies naturally produce, but like many things, its levels decline with age. Often called a "miracle molecule," NAD+ is known for supporting healthy aging and is considered one of the closest things we have to a "fountain of youth."',
    modalSubDescription: "When administered intravenously, NAD+ helps activate enzymes called sirtuins, which support your body's natural repair processes, promote overall wellness, and help reduce the effects of aging.",
    modalBenefits: [
      'Pain alleviation', 'Anti-aging benefits', 'Increased energy', 'Increased metabolism',
      'Reduced inflammation', 'Prevent and correct DNA damage',
